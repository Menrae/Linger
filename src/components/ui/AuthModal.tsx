...
export function AuthModal({ onClose }: Props) {
  ...
  const content = confirmed ? (
    ...
    >
      <div ref={dialogRef} className="bg-gray-900 rounded-2xl p-8 w-full max-w-sm mx-4 text-center">
    ...
    >
      <div ref={dialogRef} className="bg-gray-900 rounded-2xl p-8 w-full max-w-sm mx-4">
        <div className="flex rounded-lg bg-gray-800 p-1 mb-6">
          <button
            type="button"
            onClick={() => switchTab('signin')}
            className={`flex-1 rounded-md py-1.5 text-sm font-medium transition-colors ${
              tab === 'signin' ? 'bg-white text-gray-900' : 'text-gray-400 hover:text-white'
            }`}
          >
            Sign In
          </button>
          <button
            ...
            className={`flex-1 rounded-md py-1.5 text-sm font-medium transition-colors ${
              tab === 'signup' ? 'bg-white text-gray-900' : 'text-gray-400 hover:text-white'
            }`}
          >
            Sign Up
          </button>
        ...
        <form onSubmit={handleSubmit} noValidate>
          <div className="mb-4">
            ...
            <input
              ...
              autoComplete="email"
              className={`w-full bg-gray-800 text-white rounded-lg px-3 py-2 text-sm border ${
          ...
          <button
            type="submit"
            disabled={submitting}
            className="w-full bg-indigo-600 hover:bg-indigo-500 disabled:opacity-60 disabled:cursor-not-allowed text-white rounded-lg py-2 text-sm font-medium transition-colors flex items-center justify-center gap-2"
          >
            {submitting && (
        ...
        <button
          ...
          className="w-full bg-white hover:bg-gray-100 text-gray-900 rounded-lg py-2 text-sm font-medium transition-colors flex items-center justify-center gap-2"
        >
